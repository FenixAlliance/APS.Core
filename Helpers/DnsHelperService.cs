...
namespace FenixAlliance.APS.Core.Helpers
{
    ...
    public class DnsHelperService :  IDnsHelperService
    {
        ...
        public DnsHelperService(IConfiguration Configuration, ISuiteOptions SuiteOptions, ABMContext DataContext, IWebHostEnvironment Environment)
        {
